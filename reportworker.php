  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Worker Reports</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Please select starting and ending time</h3>
          ...
          <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="row">
                <form name="reports" method="POST" action="viewreport-workers.php"  enctype="multipart/form-data">
                      <div class="col-md-6">
