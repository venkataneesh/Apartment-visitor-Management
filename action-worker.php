<?php
    ...
    header('location:logout.php');
        ...
        $eid=$_GET['editid'];
        $remark=$_POST['remark'];
        $query=mysqli_query($con,"UPDATE tbldomestic set remark='$remark' where  ID='$eid'");
    ...
    <section class="content">
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <?php
            $eid=$_GET['editid'];
            $ret=mysqli_query($con,"SELECT * from  tbldomestic where ID='$eid'");
            $cnt=1;
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="apartmentno" id="apartment" value="<?php  echo $row['flatno'];?>" readonly>
                    </div>

                <div class="form-group">
                    <label>Worker Name</label>
                    <input type="text" class="form-control" name="dwname" id="dwname" value="<?php  echo $row['workerName'];?>" readonly>
                  </div>
                  <!-- /.form-group -->
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Worker's  Entry Date and Time</label>
                        <input type="text" class="form-control" name="reason" id="reason" value="<?php  echo $row['enterTime'];?>" readonly>
                    </div>
                  <!-- /.form-group -->
                ...
                <button type="submit" class="btn btn-block btn-danger btn-lg" name="submit">Check Out Worker</button>
                </div>
                <?php } else { ?>
