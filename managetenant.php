          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <?php
                $ret=mysqli_query($con,"SELECT * from tbltenant");
                $cnt=1;
                ...
                <tr>
                  ...
                  <td><?php  echo $row['landline'];?></td>
                   ...
                   <td><a href="edittenant.php?editid=<?php echo $row['ID'];?>" title="View Full Details"><i class="fa fa-edit" style="color:green;"></i></a>
                </tr>
                <?php 
                $cnt=$cnt+1;
                }?>
