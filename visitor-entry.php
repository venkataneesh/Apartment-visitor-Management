<?php
    ...
    $whomtomeet=$_POST['tname'];
    $fname = $_POST['fname'];
    $whotv = $_POST['whotv'];
    $reason=$_POST['reason'];
    

    $query=mysqli_query($con,"INSERT into tblvisitor(VisitorName, MobileNumber, Address, Gender, Apartment, BuildingNo, WhomtoMeet, Reason,faname) value('$visname','$contactnumber','$address','$gender','$apartmentno', '$buildingno', '$whotv', '$reason','$fname')");
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>Apartment Number</label>
                        <select class="form-control select2" name="apartmentno" onChange="getBuilding(this.value); getTenantName(this.value); getTenantFName(this.value); "  style="width: 100%;" required>
                        <option selected="">Choose....</option>
                        <?php $query=mysqli_query($con,"SELECT t.ID,t.tname,t.building_number,t.apartment_number,f.fname from tbltenant t join tblfamily f on t.apartment_number=f.apartment_number;");
                            while($row=mysqli_fetch_array($query)){?>    
                        <option value="<?php echo $row['ID'];?>"><?php echo $row['apartment_number'];?></option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="whotv" id="whotv" required>
                </div>
